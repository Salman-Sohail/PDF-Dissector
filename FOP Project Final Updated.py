...
def intro():
    ...
    print("\t\t\t*\t\t\t   *")
    print("\t\t\t****************************\n" + "\033[0m")
    print("\033[1;36m" + "\tMade by Salman Sohail 414744, M.Taimoor Asad 427380, M.Huzaifa Ashraf 410371 \n" + "\033[0m")
intro()
...
with pdfplumber.open(file2) as pdf:
    ...
    for i, page in enumerate(pdf.pages):
        try:
            ...
            with open("table_{}.csv".format(i+1), "w", newline="") as f:
                writer = csv.writer(f)
...
try:
    print("Total number of tables in PDF: " + str(table_count))
except:
